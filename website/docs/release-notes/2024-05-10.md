...
* **Tool Control**
  * Take control of h-bridges and PTOs directly through the Autoplot app.
  Our new [Tool Control panel](/docs/apps/amiga_v2/autoplot_app/#tool-control),
...
* **Teleoperation**
  * Enhanced teleoperation capabilities allow you to [**control**](/docs/apps/amiga_v2/autoplot_app/#how-to-control-your-amiga)
...
* **Preview images on log files**
  ...
  * If an image is part of your log, you can now [preview](/docs/apps/amiga_v2/file_manager_app/#visualize-log-files)
