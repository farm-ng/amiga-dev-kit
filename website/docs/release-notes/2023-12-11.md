...
* **Camera Preview and Control**: Introducing a brand-new [Camera app](/docs/apps/amiga_v2/camera_app/)
...
* **Copy to USB**: With automatic USB drive mounting and a redesigned
  [File Manager](/docs/apps/amiga_v2/file_manager_app/), conveniently move your data logs for offboard
