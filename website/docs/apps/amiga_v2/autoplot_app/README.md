...
- [ ] Accurate [**IMU Calibration**](/docs/apps/amiga_v2/launcher/#imu-calibration).
- [ ] The correct offsets are set in [**Robot Geometry**](/docs/apps/amiga_v2/launcher/#robot-geometry).
- [ ] [**GPS NTRIP**](/docs/apps/amiga_v2/launcher/#gps-ntrip) requirements have been met.
- [ ] Robot is connected to [**WiFi**](/docs/apps/amiga_v2/launcher/#wifi).
...
[**Autonomy Requirements**](/docs/apps/amiga_v2/autoplot_app/#autonomy-requirements) have been met.
:::
...
- Confirm that [**IMU Calibration**](/docs/apps/amiga_v2/launcher/#imu-calibration) and
[**GPS NTRIP**](/docs/apps/amiga_v2/launcher/#gps-ntrip) settings are set correctly and up-to-date.
...
If you encounter this error message, make sure you Robot meets all the [**Autonomy Requirements**](/docs/apps/amiga_v2/autoplot_app/#autonomy-requirements).
