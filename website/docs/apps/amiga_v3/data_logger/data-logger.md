...
Give your profile a name and press **Create**.
Select your newly created profile from the available list
and continue with topic selection. Click individual toggle switches
to enable or disable each data topic and press **Save Changes**.
You can also delete or update previously created profiles from this page.
Return to the main screen by pressing the **Back** button.
You may now select your newly created profile from the dropdown menu below the
...
By default these values are set to Auto but you can manually change exposure time,
ISO, and lens position. Be sure to **Apply Settings** to confirm your parameter changes
...
and press the green checkmark to confirm your new metadata entry.
...
available in the [**File Manager**](/docs/apps/amiga_v3/file_manager_v3/file-manager.md).
