...
Click on the [**GPS**](/docs/apps/amiga_v3/settings#gps-ntrip) button to
view detailed information on RTK status,
...
displays the average temperature of your robot. You can monitor the
**Uptime** of your Amiga since its last power up.
Lastly, click the **CPU and Memory** button to view your system's current resource use.
...
[**Settings**](/docs/apps/amiga_v3/settings) Configuration access and adjustments.

[**TeleOp**](/docs/apps/amiga_v3/teleop/teleop.md) Remote operation and control.

[**Map Recorder**](/docs/apps/amiga_v3/map_recorder/map-recorder.md) Navigation and mapping interface.

[**Job Manager**](/docs/apps/amiga_v3/job_manager/job-manager.md) Task scheduling and execution.

[**File Manager**](/docs/apps/amiga_v3/file_manager_v3/file-manager.md) File system browsing and management.

[**Data Logger**](/docs/apps/amiga_v3/data_logger/data-logger.md) Data recording and logging.
