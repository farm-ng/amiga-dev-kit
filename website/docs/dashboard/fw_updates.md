...
[amiga-dash-v0.7.0.zip](https://github.com/farm-ng/amiga-dev-kit/releases/download/amiga-dash-v0.7.0/amiga-dash-v0.7.0.zip)
2. For more details on the git latest release navigate to
[Release: amiga-dash-v0.7.0](https://github.com/farm-ng/amiga-dev-kit/releases/tag/amiga-dash-v0.7.0)
