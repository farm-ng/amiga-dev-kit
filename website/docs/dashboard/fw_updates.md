...
[amiga-dash-v0.6.0.zip](https://github.com/farm-ng/amiga-dev-kit/releases/download/amiga-dash-v0.6.0/amiga-dash-v0.6.0.zip)
2. For more details on the git latest release navigate to
[Release: amiga-dash-v0.6.0](https://github.com/farm-ng/amiga-dev-kit/releases/tag/amiga-dash-v0.6.0)
...
or [**service cable**](/docs/debug_cable/service_cable.md),
...
2. Connect your [**debug cable**](/docs/debug_cable/README.md) or
...
2. Drag and drop all extracted files from the downloaded firmware
update.
    ...
    root of the `CIRCUITPY` drive (as below).
        ...
        in a subfolder.
3. Once the file transfer is complete, power cycle your dashboard
...
4. If all is as expected, you're good to go. Just power down the
dashboard, disconnect the debug cable, and enjoy your new
features!
5. `[Recommended]` Navigate to the configuration tab (gear icon)
on the dashboard, and select the pendant icon to calibrate your
pendant and confirm functionality.
6. `[Recommended]` Also check the settings and ensure your
...
3. Reconnect your dashboard to power so a folder automatically
pops up under the name `CIRCUITPY`, as with the farm-ng firmware
update example above.

#### Load into BOOTLOADER mode

1. With the dashboard connected to your PC, load into
