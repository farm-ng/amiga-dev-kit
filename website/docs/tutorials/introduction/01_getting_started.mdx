...
Now that you are done creating your repository, the development flow is up to you. However, we recommend option 2 and
will develop dircetly on the brain.

1. Work in your local workspace.
    - Develop on your personal computer and pull repository changes onto the brain
2. Work in a remote Remote-SSH session using in vs-code.
    - Develop push file changes from the brain

:::info
If you are unfamiliar with git phrases such as 'push' and 'pull' we reading over our [**Github 101**](/docs/support/github-101)
:::
