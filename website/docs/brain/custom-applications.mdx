...
## Run workspace version of launcher
...
Necessary instructions for running workspace version of apps

**Option 1 (symlink)**

```bash
ln -s ~/workspace/amiga/apps/camera/ ~/apps/camera
```

toggle off apps screen, then back and Camera Dev should appear. Repeat for apps you want to see.

**Option 2 (env variable)**
```bash
export FARM_NG_APPS_PATH=/data/home/amiga/workspace/amiga/apps/
```
