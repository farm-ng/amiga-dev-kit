...
To create your own custom application navigate to the [**`amiga-app-template`**](https://github.com/farm-ng/amiga-app-template-v2) repository on GitHub.
:::tip
...
1. Prepare the frontend and compile the typescript code to javascript
