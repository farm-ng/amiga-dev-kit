...
:::tip
Make sure you are on the **Linux** tab when you go to the GitHub docs (links below). The page defaults to the system you are on and dosen't know you are SSH'd into a Linux machine, which the Amiga is.
:::
...
```bash
cd apps/
# Replace 'YOUR-USERNAME/YOUR-REPOSITORY' bwloe with the correct link to your new repo
