...
def parse_packet(packet):
    ...
    if False:
        print('FVP - CH1:{:>4} , CH2:{:>4} , CH3:{:>4} , CH4:{:>4}'.format(
            channel_0, 
            channel_1,
            channel_2,
            channel_3))
...
class FpvApp:
    def __init__(self, main_loop:MainLoop, can, node_id):
        ...
        self.axis2 = Axis(min_value=172, deadzone_m1=950, deadzone_p1=1050,
            max_value=1811)

        self.axis3 = Axis(min_value=172, deadzone_m1=950, deadzone_p1=1050,
            max_value=1811)
